    ...
    linux: {
        ...
        oh_my_zsh: {
          ...
          howtoList: {
            "oh-my-zsh-installation.howto": {
              ...
              filePath:
                "/home/maemresen/tmp/howto/linux/oh_my_zsh/oh-my-zsh-installation.howto",
              markdownContent:
      ...
      howtoList: {
        "linux-make_bootable_usb.howto": {
          ...
          filePath:
            "/home/maemresen/tmp/howto/linux/linux-make_bootable_usb.howto",
          markdownContent:
        ...
        "linux-open_ssl-encryption_decryption.howto": {
          ...
          filePath:
            "/home/maemresen/tmp/howto/linux/linux-open_ssl-encryption_decryption.howto",
          markdownContent:
        ...
        "linux-scan_devices_on_network.howto": {
          ...
          filePath:
            "/home/maemresen/tmp/howto/linux/linux-scan_devices_on_network.howto",
          markdownContent:
        ...
        "linux-fstab_ile_auto_mount.howto": {
          ...
          filePath:
            "/home/maemresen/tmp/howto/linux/linux-fstab_ile_auto_mount.howto",
          markdownContent:
    ...
    docker: {
      ...
      howtoList: {
        "docker-Wordpress-Docker_Container.howto": {
          ...
          filePath:
            "/home/maemresen/tmp/howto/docker/docker-Wordpress-Docker_Container.howto",
          markdownContent:
        ...
        "docker-MySQL-Docker_Container.howto": {
          ...
          filePath:
            "/home/maemresen/tmp/howto/docker/docker-MySQL-Docker_Container.howto",
          markdownContent:
        ...
        "docker-rstudio-server_docker_container.howto": {
          ...
          filePath:
            "/home/maemresen/tmp/howto/docker/docker-rstudio-server_docker_container.howto",
          markdownContent:
        ...
        "docker-gitlab-docker_container.howto": {
          ...
          filePath:
            "/home/maemresen/tmp/howto/docker/docker-gitlab-docker_container.howto",
          markdownContent:
        ...
        "sublim-text3-latex_configuration": {
          ...
          howtoList: {
            "_TODO.howto": {
              ...
              label: "_TODO.howto",
              filePath:
                "/home/maemresen/tmp/howto/latex/sublim-text3-latex_configuration/_TODO.howto",
              markdownContent:
                "Update document to show configure it in windows if its possible",
            },
        ...
        Torch: {
          ...
          howtoList: {
            "installation.howto": {
              ...
              filePath:
                "/home/maemresen/tmp/howto/ai_tools/Torch/installation.howto",
              markdownContent:
    ...
    nano: {
      ...
      howtoList: {
        "nano-syntax_highlighting.howto": {
          ...
          filePath:
            "/home/maemresen/tmp/howto/nano/nano-syntax_highlighting.howto",
          markdownContent:
        ...
        Eclipse: {
          ...
          howtoList: {
            "eclipse-shortcuts_configuration.howto": {
              ...
              filePath:
                "/home/maemresen/tmp/howto/ide/Eclipse/eclipse-shortcuts_configuration.howto",
